...
public class ST_PuzzleDisplay : MonoBehaviour
{
    ...
    public IEnumerator CheckForComplete()
    {
        ...
        if (Complete)
        {
            ...
            SacuvajVarijableZaPuzzleSkripta.zavrsenaPuzzla = true;
            SacuvajVarijableZaPuzzleSkripta.vratioSeIzScene = true;
            Button dugmeZaKraj = GameObject.Find("BackPuzzle").GetComponent<Button>();
            dugmeZaKraj.onClick.Invoke();
        }
